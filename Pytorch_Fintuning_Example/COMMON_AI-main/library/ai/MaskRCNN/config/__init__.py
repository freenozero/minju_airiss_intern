...
from library.ai.MaskRCNN.utils.io import split_path_name, check_dir_list

def config_set(config_full_path):
    #config_full_path = "./library/ai/MaskRCNN/config/train_config.py"
...
train_configs = config_set("./library/ai/MaskRCNN/config/train_config.py")
