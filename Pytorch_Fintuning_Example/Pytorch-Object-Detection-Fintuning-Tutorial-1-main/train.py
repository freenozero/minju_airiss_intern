...
def main():
    ...
    dataset = PennFudanDataset("D:\wp\minju_airiss_intern\Pytorch_Fintuning_Example\Pytorch-Object-Detection-Fintuning-Tutorial-1-main\PennFudanPed", get_transform(train=True))
    dataset_test = PennFudanDataset("D:\wp\minju_airiss_intern\Pytorch_Fintuning_Example\Pytorch-Object-Detection-Fintuning-Tutorial-1-main\PennFudanPed", get_transform(train=False))
