# 목차
[데이터 증강(rotate)](#data_augmentation-데이터-증강-1)
[groundtruths](#data_augmentation-추가-이미지-seg-bbox-시각적-표현-2)
[feedback](#data_augmentation-feedback-적용-3)
[category 단일화](#background_image-augmentation--categorical-단일화-4)
[manipulation](#background_image-manipulation-5)
[high, low image size 맞추기](#background_image-categorical-low-high-이미지-사이즈-맞추기-6)
[이미지 증강 코드 개선 및 모듈화, 폴더 정리](#refactor-이미지-증강-관련-코드-개선-및-모듈화-폴더-정리-7)
[manipulation json 파일 생성](#background_image-manipulation-이미지-json-파일-생성-8)
[manipulation 이미지 groundtruths](#background_image-manipulation-이미지-seg-bbox-시각적-표현-10)
[pytorch study](#study-pytorch-11)
[pytorch penfudanped](#study-penfudanped-12)
[tran, val, test set 나누기](#background_image-train-val-test-set-13)
[manipulation 이미지 전처리 학습](#background_image-manipulation한-데이터들-학습을-위해-변경-14)
[cuda cudnn 설치](#mask_rcnn-cuda--cudnn-설치-15)
[manipulation 이미지 학습](#mask_rcnn-object-detectionmanipulation-image-17)
[manipulation 이미지 검증](#mask_rcnn-object-detectionmanipulation-image-2-18)
[manipulation 이미지 검증 후 precision, recall 구하기](#mask_rcnn-object-detectionmanipulation-image-3-20)
